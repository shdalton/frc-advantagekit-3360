...
public abstract class ModuleIOTalonFXMag implements ModuleIO {
  ...
  protected final CTREMagEncoder magcoder;
  ...
  protected ModuleIOTalonFXMag(
    ...
    magcoder = new CTREMagEncoder(constants.EncoderId);
    ...
    turnConfig.Feedback.FeedbackSensorSource =
        switch (constants.FeedbackSource) {
          ...
          default ->
              throw new IllegalStateException("Unexpected value: " + constants.FeedbackSource);
        };
  ...
  public void updateInputs(ModuleIOInputs inputs) {
    ...
    inputs.turnAbsolutePosition = Rotation2d.fromRotations(magcoder.getAbsolutePosition());
